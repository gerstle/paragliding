...
def convert(
    ctx: typer.Context,
    source_file: Annotated[str, typer.Option('--source', '-s', help='Source file to convert from')],
    destination_file: Annotated[str, typer.Option('--destionation', '-d', help='destination_file file to convert to')],
):
